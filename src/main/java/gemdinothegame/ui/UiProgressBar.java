...
public class UiProgressBar extends UiComponent {
    ...
    public UiProgressBar(App app, final Screen screen, final double x, final double y, final int width, final int height, final BufferedImage leftBarImg, final BufferedImage midBarImg, final BufferedImage rightBarImg) {
